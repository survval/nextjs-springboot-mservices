 ...
 * <p>
 * This configuration creates a Keycloak admin client bean that can be used to manage
 * Keycloak realms, clients, roles, and users.
 */
@Slf4j
@Configuration
...
public class KeycloakConfig {
	 ...
	 * <p>
	 * This client connects to the master realm with the admin-cli client and uses the
